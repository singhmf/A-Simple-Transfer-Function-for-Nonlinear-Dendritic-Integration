...
Exp1=(Depol1-NMDAmid)/NMDAks+log(1+gNMDA*Rm); %Exponent of equation 13.2
...
elseif ISI>0
    ...
    g2=gNMDA*max(1,1.6*(1-ISI/.1)); % Using method of Gomez-Gonzalez to increase NMDAR conductance for second pulse with short ISI (ISI parameter in seconds)
